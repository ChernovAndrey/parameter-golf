...
class GPT(nn.Module):
	def __init__(self,h):
		...
		# Qwen G1 gating and MLP 3.1x (PARALLEL_MLP_MULT). Hypothesis: the gate
		...
		# Per-token MLP volume in this zone (4 x h=1587 = 6348) closely matches
		# FatBlock's validated regime (1 x h=6144). Predicted artifact ~15.63 MB.
		blocks_list=[]
